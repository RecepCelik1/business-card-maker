...
const initialState = {
     countries : [
        ...
        { value: 'Bangladesh', label: 'United'},
        { value: 'Barbados', label: 'Barbados'},
        { value: 'Belarus', label: 'Belarus'},
        { value: 'Belgium', label: 'Belgium'},
        { value: 'Belize', label: 'Belize'},
        { value: 'Bhutan', label: 'Bermuda'},
        ...
        { value: 'Dominic Republic', label: 'Dominic Republic'},
        ...
        { value: 'Norfold Island', label: 'Norfold Island'},
        ...
        { value: 'Turks & Caicos Island', label: 'Turks & Caicos Island'},
        ...
        { value: 'United Kingdom', label: 'United Kingdom' , i : "UKStates"},
        { value: 'United States', label: 'United States' , i : "USstates"},
    ...
    UKStates : [
      { value: "British Forces", label: 'British Forces'},
    ...
    USselectedState : "Select a State",
    UKselectedState : "Select a State"

}


export const CountriesAndStates = createSlice({
name: 'countries&states',
initialState,
reducers: { 
    selectedStateFunc: (state, action) => {
        state[action.payload.field]= action.payload.selectedOption
      },
},
})

// Action creators are generated for each case reducer function
export const { selectedStateFunc } = CountriesAndStates.actions

export default CountriesAndStates.reducer